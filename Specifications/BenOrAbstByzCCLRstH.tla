---- MODULE BenOrAbstByzCCLRstH ----
(* This is a refinement of BenOrMsgsByzCCLRst, BenOrAbstByzCCLRst, and BenOrMsgsByzCCLRstH with additional refinement history variables.
   ...
   The refinement mappings RefMsgsH and RefAbstCCLRst are also provided and can be checked with TLC if put inside the RefinementProperty
